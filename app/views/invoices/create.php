<div class="sm:flex sm:items-center sm:justify-between mb-6">
    <h1 class="text-2xl font-semibold leading-6 text-gray-900">Nueva Factura</h1>
    <?= ui_button('Volver', 'secondary', 'arrow-left', ['href' => BASE_URL . '/invoices.php', 'tag' => 'a']) ?>
</div>

<div class="bg-white shadow sm:rounded-lg">
    <div class="px-4 py-5 sm:p-6">
        <form action="<?= BASE_URL ?>/invoices.php?action=store" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 gap-x-6 gap-y-6 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <div class="mt-2">
                         <input type="text" name="number" id="number" required placeholder="Ej: F-2023-001" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-slate-600 sm:text-sm sm:leading-6">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="relative mt-2 rounded-md shadow-sm">
                        ...
                        <input type="number" step="0.01" name="amount" id="amount" required class="block w-full rounded-md border-0 py-1.5 pl-7 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-slate-600 sm:text-sm sm:leading-6">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <input type="date" name="issue_date" id="issue_date" value="<?= date('Y-m-d') ?>" required class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-slate-600 sm:text-sm sm:leading-6">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <input type="date" name="due_date" id="due_date" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-slate-600 sm:text-sm sm:leading-6">
                    </div>
                </div>
            ...
            <div class="flex items-center justify-end gap-x-6 border-t border-gray-900/10 pt-4">
                 <?= ui_button('Guardar Factura', 'primary', 'check', ['type' => 'submit']) ?>
            </div>
        </form>
    </div>
</div>
